...
static const char *const autostart[] = {
    ...
    "dunst",
    "-c",
    "/home/axel/.config/dunst/dunstrc",
    NULL,
    /*"picom",
    ...
    "xrdb",
    "-merge",
    "/home/axel/.config/x11/.Xresources",
    NULL,
    "xautolock",
    "-corners",
    "----",
    ...
    "5",
    "-locker",
    "/home/axel/bin/scripts/locker.sh",
    NULL,
    NULL /* terminate */
};
...
static const Rule rules[] = {
    ...
    {"KeePassXC", "keepassxc", "Unlock Database - KeePassXC", 1 << 8, 1, 0, 1,           -1 },
    ...
    TAGKEYS(XK_ampersand, 0) TAGKEYS(XK_eacute, 1) TAGKEYS(XK_quotedbl, 2)
        TAGKEYS(XK_apostrophe, 3) TAGKEYS(XK_parenleft, 4) TAGKEYS(XK_minus, 5)
            TAGKEYS(XK_egrave, 6) TAGKEYS(XK_underscore, 7) TAGKEYS(
                XK_ccedilla, 8)
    {MODKEY | ShiftMask, XK_q, spawn,SHCMD("~/.local/bin/scripts/poweroff.sh")},
